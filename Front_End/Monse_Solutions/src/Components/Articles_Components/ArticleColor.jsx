...
const ArticleColor = () => {
    return (
      <div className="color-container">
        ...
        <section className="color-what-is">
          <h2 className="color-subtitle">What is preventive home maintenance?</h2>
          <p className="color-text">
            Preventive maintenance involves conducting regular inspections and upkeep to prevent major issues in the future. It’s a way of anticipating structural damage, electrical failures, plumbing issues, and other inconveniences that may arise. By dedicating time to these tasks, you not only improve the functionality of your home but also increase its long-term value.
          </p>
        </section>
  
        {/* Lista de áreas clave para mantenimiento preventivo */}
        <section className="color-key-areas">
          <h2 className="color-subtitle2">Key areas for preventive maintenance</h2>
          ...
          <p className="color-tip"><span className="highlight">Pro Tip:</span> Hire a professional electrician for a full system check-up once a year.</p>
          ...
          <p className="color-tip"><span className="highlight">Pro Tip:</span> Keep a basic plumbing repair kit in your home for minor fixes.</p>
          ...
          <p className="color-tip"><span className="highlight">Pro Tip:</span> Use moisture-resistant paints in areas prone to leaks.</p>
          ...
          <p className="color-tip"><span className="highlight">Pro Tip:</span> Use a humidifier to maintain optimal air quality in dry climates.</p>
          ...
          <p className="color-tip"><span className="highlight">Pro Tip:</span> During inspections, pay attention to loose or worn tiles as they can cause significant damage if not addressed.</p>
        </section><br />
  
        {/* Beneficios del mantenimiento preventivo */}
        <section className="color-benefits">
          <h2 className="color-subtitle">Benefits of Preventive Maintenance</h2>
          <ul className="color-benefits-list">
        ...
        {/* Llamada a la acción */}
        <section className="color-cta-section">
          <h2 className="color-cta-title">Keep your home safe and functional!</h2>
          <p className="color-cta-text">Preventive maintenance is the key to protecting your home and its value. Start today to ensure the longevity of your investment.</p>
          <div className="color-cta-button-container">
            <div className="color-cta">
              <Link to="/store" className="color-btn2">
                Buy basic home repair kit!
              </Link>
            </div>
          </div>
