...
from datetime import timedelta #Import para el metodo en Simple jwt.
...
SECRET_KEY = 'django-insecure-dvn4_%k2zs-(#as$j+ml&zl=0@_l_wp_gdcv39##)_3_mn&jew'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'monse_solutions',  # El nombre de tu base de datos en MySQL
